...
export declare const Processor: import("@webiny/di").Abstraction<IProcessor<any, any>>;
export declare namespace AccessCheck {
...
export declare namespace Processor {
  ...
  type AfterShardContext = IAfterShardContext;
  /**
   ...
   */
  type Context = BaseTransformContext.Interface<unknown>;
  /** Extract the slice type from a Processor Implementation class. */
  type SliceOf<P> = P extends {
    extendContext(base: any): infer S;
  }
    ? S
    : Record<string, never>;
}
