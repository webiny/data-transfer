...
export declare const PipelineBuilderFactory: Abstraction<IPipelineBuilderFactory>;
export declare namespace PipelineBuilderFactory {
  type Interface = IPipelineBuilderFactory;
  type FactoryInput<TScanner, TProcessors> = PipelineFactoryInput<TScanner, TProcessors>;
}
export {};
