import { z } from "zod";
export declare const unifiedTransferInputSchema: z.ZodObject<
  {
    source: z.ZodObject<
      {
        region: z.ZodString;
        credentials: z.ZodUnion<
          readonly [
            ...
            >,
            z.ZodCustom<
              import("./shared.schema.ts").AwsCredentialsProvider,
              import("./shared.schema.ts").AwsCredentialsProvider
            >
          ]
        >;
    ...
    register: z.ZodOptional<
      z.ZodCustom<import("./shared.schema.ts").RegisterFn, import("./shared.schema.ts").RegisterFn>
    >;
