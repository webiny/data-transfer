 ...
 */
export async function visitFields(values, modelFields, callback) {
  for (const field of modelFields) {
    ...
    if (field.type === "object") {
      ...
      if (field.multipleValues && Array.isArray(value)) {
        ...
        for (const item of value) {
          if (item && typeof item === "object") {
            await visitFields(item, nestedFields, callback);
          }
        }
      } else if (typeof value === "object" && value !== null) {
        // Single object
        await visitFields(value, nestedFields, callback);
      }
      ...
      for (const item of items) {
        ...
        const itemObj = item;
        const templateId = itemObj._templateId;
...
//# sourceMappingURL=fieldVisitor.js.map
