    ...
    .command(
        ...
        async argv => {
            ...
            try {
                ...
                const workerCommand =
                    config.storage === "os" ? "process-os-segment" : "process-segment";
    ...
    .command(
        ...
        async argv => {
            ...
            if (config.storage !== "ddb") {
                throw new Error(
                    `process-segment requires storage: "ddb". Got: "${config.storage}"`
                );
            }
    ...
    .command(
        ...
        async argv => {
            ...
            if (config.storage !== "os") {
                throw new Error(
                    `process-os-segment requires storage: "os". Got: "${config.storage}"`
                );
            }
